...
int main(int argc, char **argv) {
  ...
  MmxRenderView view = !strcmp(argv[3], "4:3") ? (MmxRenderView){256,0,4.0/3.0} :
      !strcmp(argv[3], "max") ? MmxRendererViewport(MMX_ASPECT_ADAPTIVE, 2048, 300, kSnesDisplayAspect_Crt4x3) : MmxRendererViewport(aspect, 16, 9, kSnesDisplayAspect_Crt4x3);
