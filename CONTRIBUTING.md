...
Pull requests run ROM-free source checks. Maintainer pushes and manual workflow
runs additionally build platform artifacts using the private `MMX_ROM_BASE64`
repository secret.
